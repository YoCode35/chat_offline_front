...
//       const users = await http().get<User[]>("/uncontacted-users");
...
//       if (style?.backgroundColor !== "#e3f2fd") {
//         // Pas pour l'élément actif
//         e.currentTarget.style.backgroundColor =
//           style?.backgroundColor === "transparent" ? "#f5f5f5" : "#f0f0f0";
//       }
//     };
...
//         // Pas pour l'élément actif
//         e.currentTarget.style.backgroundColor =
//           style?.backgroundColor === "#e3f2fd" ? "#e3f2fd" : "transparent";
//       }
//     };
...
//             {usersLoading ? "..." : `${totalUsers} personnes ont un compte!`}
//           </div>
//         </div>
...
//           <span
//             style={{
//               transform: showConversations ? "rotate(90deg)" : "rotate(0deg)",
//               transition: "transform 0.2s ease",
//             }}
//           >
//             ▶
...
//                 transition: "all 0.2s ease",
//                 backgroundColor:
//                   isConnected && input.trim() !== "" ? "#2196f3" : "#ccc",
//                 cursor:
